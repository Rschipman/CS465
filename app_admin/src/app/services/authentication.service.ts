...
export class AuthenticationService {
  ...
  // Because that mothod returns an observable, we subscribe to the 
  ...
  // Because that method redturns an observable, we subscribe to the result
  // and only process when the Observable condition is satisfied
  // Uncomment the two console.log messages for additional debugging information
  // Please Note: This method is nearly identical to the login method because the
  // behaviour of the API logs a new user in immediately upon registration
